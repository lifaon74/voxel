...
} from '../../voxel/octree/functions/voxel-material/at-position/read_voxel_material_address_of_voxel_octree_at_position';

import { ISliceVoxelOctreeCallback } from './slice-voxel-octree-callback.type';


export function slice_octree_using_read_voxel(
  z: number,
