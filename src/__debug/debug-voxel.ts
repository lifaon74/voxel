...
function debugVoxel1() {
  ...
  const redVoxelMaterialAddress = allocate_and_write_voxel_material_in_memory(
    memory,
    alloc,
    255,
    0,
  ...
  const greenVoxelMaterialAddress = allocate_and_write_voxel_material_in_memory(
    memory,
    alloc,
    0,
    255,
  ...
  const blueVoxelMaterialAddress = allocate_and_write_voxel_material_in_memory(
    memory,
    alloc,
    0,
    0,
