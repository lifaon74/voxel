...
export function convert_generic_vox_chunk_to_matt_vox_chunk(
  ...
  return {
    ...
    propertyValues: new Float32Array(chunk.bytes.buffer, chunk.bytes.byteOffset + alloc(0), (chunk.bytes.length - alloc(0)) / Float32Array.BYTES_PER_ELEMENT),
  };
}
